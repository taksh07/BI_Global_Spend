...
#Cost Report
echo -e 'client_id\tclient_name\tcustomer_id\tyear\tmonth\tlocal_cost\ttraffic_cost\tGoogle_cost\tYJP_cost\tYDN_cost\ttraffic_folder\tactive_campaigns_traffic\tall_campaigns' > global_spend_report.csv
shuf Global_Client_List.txt | xargs -P 20  -L 1 ./jp_spend.sh >> global_spend_report.csv
